...
import 'package:ecommerce_app/view/features/authentication/reset_password_screen.dart';
...
import '../../widgets/screen_widgets/otp_screen_widgets/custom_otp_text_form_field_widget.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style:  myStyleRoboto14(color: appAddToCartColor),
              ),
              const SizedBox(
                height: 50,
              ),
                        ...
                        return Row(
                          ...
                          children: [
                            Text(
                              ...
                              style: myStyleRoboto14(color: Theme.of(context).textTheme.labelLarge!.color!),
                            ),
                            GetBuilder<OtpController> (
                                builder: (controller) {
                                  return controller.otpTimerValue > 0 ?  Text(
                                    " ${controller.formatTime()}",
                                    style: myStyleRoboto16(color: Theme.of(context).primaryColor ),
