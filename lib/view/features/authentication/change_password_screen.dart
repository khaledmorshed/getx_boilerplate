          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Text("Current Password", style: myStyleRoboto14(color: GetTheme().txtTheme().txtLabelColorMoreMedium!)),
                  szH6(),
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("New Password", style: myStyleRoboto14(color: GetTheme().txtTheme().txtLabelColorMoreMedium!)),
                  szH6(),
                  GetBuilder<ChangePasswordController>(
                      builder: (controller) {
                        return CustomTextFormField(
